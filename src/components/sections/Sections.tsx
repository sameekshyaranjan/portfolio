    ...
    <section id="contact" className="py-24 md:py-32 bg-[#0D0D10] border-t border-[#1E1E22]">
      <Container>
        ...
        <motion.p {...reveal} className="mt-4 text-[#8A8A9A] max-w-xl">
          Always open to internship and full-time opportunities — full-stack development, AI-integrated products, or anything that involves solving real engineering problems.
        </motion.p>
